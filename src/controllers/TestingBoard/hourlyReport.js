import { sequelize, UnilineHourlyReport } from '../../models';
...
export const postHourlyReportData=async(req,res)=>{
    try{
        ...
        const report= await UnilineHourlyReport.create({
            deviceTotal:req.body.deviceTotal,
            deviceOnline:req.body.deviceOnline,
            inverterTotal:req.body.inverterTotal,
            inverterOnline:req.body.inverterOnline,
            BatteryShutDown:req.body.BatteryShutDown,
            BatterLow:req.body.BatteryLow,
            ward:req.body.Ward,
            zone:req.body.Zone,
